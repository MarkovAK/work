...
public:
	...
	bool write_binary_value(std::wstring path, std::wstring name, std::string value);
	bool write_dword_value(std::wstring path, std::wstring name, long value);
	bool write_qword_value(std::wstring path, std::wstring name, long long value);
	bool write_sz_or_expand_value(std::wstring path, std::wstring name, bool expand, std::wstring value);
	bool write_multi_sz_value(std::wstring path, std::wstring name, std::vector<std::wstring> value);
